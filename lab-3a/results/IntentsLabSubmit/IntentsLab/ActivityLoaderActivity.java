...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// XXX - Create a new intent to launch the ExplicitlyLoadedActivity class
		Intent explicitIntent = new Intent(this,ExplicitlyLoadedActivity.class);

		// XXX - Start an Activity using that intent and the request code defined above
	...
	private void startImplicitActivation() {
		...
		// XXX - Create a base intent for viewing a URL
		// (HINT:  second parameter uses Uri.parse())
		Uri url = Uri.parse(URL);
		Intent baseintent = new Intent(Intent.ACTION_VIEW);
		baseintent.setData(url);

		// XXX - Create a chooser intent, for choosing which Activity
		...
		// XXX - Start the chooser Activity, using the chooser intent
