	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// XXX - Indicate result and finish
		...
		// XXX - Set up OnClickListener for the Reset Button
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// XXX - Reset data to default values
				mTitleText.setText("");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// XXX - Get the current Priority
				Priority priority = getPriority();

				// XXX - Get the current Status
				Status status = getStatus();

				// XXX - Get the current ToDoItem Title
				...
				// XXX - return data Intent and finish
